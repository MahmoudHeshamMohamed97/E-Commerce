...
namespace Project.Controllers
{
    ...
    public class Item
    {
        ...
        [ForeignKey("Store")]
        public Nullable<int> StoretId { get; set; }
        [ForeignKey("Product")]
    ...
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create(int total)
        {
            ViewBag.cost = total;
        ...
        public IActionResult Create(Order order)
        {
            ...
            Order createdOrder = JsonConvert.DeserializeObject<Order>(res.Content.ReadAsStringAsync().Result);
            ...
            foreach (var item in GetItems())
            {
                ...
                HttpResponseMessage response = client.PostAsJsonAsync("https://localhost:44329/api/Items", item).Result;
            }
        ...
        public IActionResult Edit(Order order)
        {
            ...
            order.OrderDate = OrderEditOBJ.OrderDate;
        ...
        public IActionResult Delete(int id)
        {
            ...
            ProductList = response2.Content.ReadAsStringAsync().Result;
            List<Product> allProducts = JsonConvert.DeserializeObject<IList<Product>>(ProductList).ToList();
            if (OrderDeleteOBJ.Confirm)
            {
                foreach (var item in OrderDeleteOBJ.Items)
                {
                    foreach (var Product in allProducts)
                    {
                        if (item.Product.ID == Product.ID)
