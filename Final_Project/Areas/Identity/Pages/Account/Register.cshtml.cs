    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new CustomIdentityUser { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, CountedID = allCustomer.Count + 1, LastName = Input.LastName, PhoneNumber = Input.Phone, Phone = Input.Phone, DateOfJoin = DateTime.Now, IsAdmin = (allCustomer.Count == 0) };
